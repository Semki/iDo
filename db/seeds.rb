...
fatman = Achievement.create({:name => 'Fatman', :description => "I'm lovin' it", :duration => '1', :count => '1', :activity_id => activity_eating.id, :picture_url => 'fatman.png' })

#activity_coding = Activity.create({:name => 'Coding'})
activity_working = Activity.create({:name => 'Working', :picture_url => 'working.png'})
Achievement.create({:name => 'hard worker', :description => 'no pain no gain!', :duration => '1', :count => '1',
...
Achievement.create({:name => 'super cleaner', :description => 'wash it!', :duration => '1', :count => '1',
...
Achievement.create({:name => 'shopoholic', :description => 'you can buy more!', :duration => '10', :count => '1',
...
runner_achievement = Achievement.create({:name => 'Runner lvl 1', :description => 'Run, Forest, run!', :duration => '100', :count => '2', :activity_id => activity_running.id, :picture_url => 'running.png' })
...
Achievement.create({:name => 'Drinker', :description => 'to see a snake in the boot!', :duration => '1', :count => '10',
